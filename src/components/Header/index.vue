<template>
	<div class="box">
		...
		<div class="header-area" v-show="$route.meta.Show">
			<!-- 头部大图 -->
			<div class="container">
				<img src="../../assets/title.jpg" alt="" class="header-img"/>
		...
		<div class="header-login">
			<div class="container">
				...
				<div class="header-right">
					<ul>
						<li><router-link to="/myorderlist">我的订单</router-link></li>
						<li><router-link to="/shopcart">CC购物车</router-link></li>
						<li><a href="#">我的CC</a></li>
						<li><a href="#">CC会员</a></li>
						<li><a href="#">企业采购</a></li>
						<li><a href="#">关注CC</a></li>
		...
		<div class="logoSearch">
			<div class="container">
				<div class="logo">
					<router-link :to="{ path: '/home' }"><img src="../../assets/logo2.png" alt=""/></router-link>
				</div>
				<div class="search">
